...
```{r fig74, warning=FALSE, fig.cap="Comparación de Series en Diferencias Mensuales y Anuales (Logarítmicas)", fig.align='center'}
...
```{r fig75, warning=FALSE, fig.cap="Comparación de Series en Niveles (Logaritmos) y en Diferencias Logarítmicas", fig.align='center'}
