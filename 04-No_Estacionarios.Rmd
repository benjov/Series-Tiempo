...
Table: (\#tab:ZA-summary) Resumen de resultados de la prueba Zivot-Andrews (ZA) para $LTC_t$.

| **Modelo** | **Estadístico** | **1% CV** | **5% CV** | **10% CV** | **Quiebre estimado** |
|:-----------|:----------------|:---------:|:---------:|:----------:|:--------------------:|
| Modelo A   | —               | \(-5.34\) | \(-4.80\) | \(-4.58\)  | —                   |
| Modelo B   | —               | \(-4.93\) | \(-4.42\) | \(-4.11\)  | —                   |
| Modelo C   | —               | \(-5.57\) | \(-5.08\) | \(-4.82\)  | —                   |
