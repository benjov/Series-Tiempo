...
urdf_fila <- function(lbl, obj) {
  data.frame(Modelo      = lbl,
             ...
             CV_5pct     = round(obj@cval[2, 1], 4),
             CV_10pct    = round(obj@cval[3, 1], 4))
}
...
La prueba de Zivot y Andrews (1992) extiende la prueba ADF para el caso en que existe un quiebre estructural en una fecha desconocida $\tau^*$. La prueba evalúa tres modelos:
