...
```{r fig_sim_ur, fig.cap="AR(1) estacionario vs. Caminata Aleatoria. Ambos procesos usan el mismo ruido blanco.", fig.align='center', warning=FALSE}
set.seed(2024)
T   <- 300
e   <- rnorm(T)
...
Table: (\#tab:ADF-summary) Resumen de resultados de la prueba Augmented Dickey-Fuller (ADF) con 5 rezagos (resultado de $p = int \{ 4 (282/100)^{(1/4)} \} = 5$).
