# Causalidad de Granger, Modelos Multivariados de Vectores Autoregresivos y de Cointegración, Modelos ARDL y Filtro Multivariado {#cap-var}
...
diagn_fila <- function(nombre, stat, pval) {
  data.frame(
    ...
    pvalor      = round(pval, 4),
    Conclusion  = ifelse(pval < 0.05, "Se rechaza $H_0$", "No se rechaza $H_0$")
  )
}
...
continuación, utilizaremos la definición de Engle y Granger (1987) de
cointegración.
...
> **Nota:** Para este ejemplo, se ocupa el QPM básico presentado por IMF (2020) en su curso "Monetary Policy Analysis and Forecasting" disponible en la plataforma edX. El código de Matlab fue realizado por el IMF.
