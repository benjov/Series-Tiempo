...
# Normalidad (Jarque-Bera multivariado):
normality.test(VAR_p)

# Autocorrelación serial — LAGS = 2:
serial.test(VAR_p, lags.bg = 2, type = "BG")

# Autocorrelación serial — LAGS = 4:
serial.test(VAR_p, lags.bg = 4, type = "BG")

# Autocorrelación serial — LAGS = 6:
serial.test(VAR_p, lags.bg = 6, type = "BG")

# Homocedasticidad (ARCH multivariado):
