...
Estas notas corresponden al curso de **Análisis de Series de Tiempo** de la Facultad de Economía de la Universidad Nacional Autónoma de México (UNAM) y al curso de **Econometría III** del Tecnológico de Monterrey. Están orientadas a estudiantes de licenciatura con conocimientos previos de econometría y probabilidad, y tienen como objetivo ofrecer una introducción rigurosa pero accesible a los principales modelos de series de tiempo, tanto desde la perspectiva teórica como computacional.
