...
Pierce (1970) desarrollaron la siguiente estadística: \begin{equation}
...
$S$ y $K$, respectivamente, Jarque y Bera (1980) propusieron una prueba
...
tiempo: procesos autoregresivos (AR, por sus siglas en inglés) y
...
trabajo original, Hodrick y Prescott (1997) utilizaron datos
...
Prescott (1997) la constante $\lambda$ debe tomar valores específicos de
...
A continuación, ilustraremos el filtro de Hodrick y Prescott (1997) para
...
Existen una técnica adicional que soluciona un problema de
distribuciones de colas pesadas es el planteado por St-Amant & van
Norden. Analicemos ese caso. Método tradicional de HP consiste en
...
Ravn (2004), el cual consiste en utilizar un $\lambda$ convencional y el
...
Nota: Antón (2009) estimó $\lambda_{ss} = 1096$ para datos trimestrales
del PIB.
...
**Modelos AR, MA y ARMA.** Los procesos autoregresivos $AR(p)$ modelan
