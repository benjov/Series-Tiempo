...
crecimiento\footnote{Estas tasas no son porcentuales, para hacerlas porcentuales faltaría multiplicar por 100 cada valor de la serie.}
...
característico:\footnote{Note que raíces son equivalentes al inverso de las del polinomio dado por $\lambda^2 a_2 - \lambda a_1 - 1 = 0$.}
\begin{equation}
...
Consumidor
(INPC).\footnote{Las definiciones de las variables ocupadas es:
