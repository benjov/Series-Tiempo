...
Para el proceso de estimación, la ecuación \@ref(eq:eqPVAR) se modifica en su versión en diferencias para quedar como:
\begin{equation}
...
Estabilidad del proceso autorregresivo:
