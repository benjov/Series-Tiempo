...
> **Nota:** El desarrollo completo de las pruebas de cointegración en panel (Pedroni, Kao, Westerlund) y el modelo de corrección de error en panel (PVEC) se incluirá en una versión posterior de estas notas.
...
\begin{enumerate}
    \item Modelos caracterizados por una variable observable, por lo que tenemos certeza de los regímenes en cada uno de los momentos.
...
\begin{enumerate}
    ...
    \item Probar una hipótesis nula de no linealidad de acuerdo con alguno de los modelos SERAR, STAR o MSM
    
    \item Estimar lo parámetros
    
    \item Evaluar los resultados del modelo
    
    \item Ajustar, en su caso, la estimación o modelo
    
    \item Pronosticar o realizar análisis impulso-respuesta
\end{enumerate}
